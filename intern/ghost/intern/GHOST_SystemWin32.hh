...
class GHOST_SystemWin32 : public GHOST_System {
 ...
 protected:
   ...
   */
  static std::unique_ptr<GHOST_EventKey> processKeyEvent_raw(GHOST_WindowWin32 *window, RAWINPUT const &raw);
   ...
   */
  static std::unique_ptr<GHOST_EventKey> processKeyEvent_key(GHOST_WindowWin32 *window, USHORT msg, WPARAM wparam, LPARAM lparam);
