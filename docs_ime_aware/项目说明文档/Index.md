...
项目本身只是为了收集用户反馈并完善代码，并最终将完善后的代码推送给官方。

但鉴于合并时间不定，且部分用户无法正常使用“输入法助手”。

所以项目重新以正式版发布，为用户提供一个另一个解决输入法问题的方案。

注：正式版解除了测试版设置的启动限制，可以直接双击启动。

额外针对 Blender 4.4 及以上版本增加的功能：

- 支持在文本序列片段编辑模式中使用输入法输入文本。
